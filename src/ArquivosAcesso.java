...
public class ArquivosAcesso {
	...
	private int tamReg;
	private int tamHead;
	private static final int STRING_MAX_TAM = 40;
	...
	public void openFile(String path) {
		...
		// se arquivo nao existe definie numReg como 0. Se o arquivo já existe, mantenha como -1
		if (!f.exists())
		this.numReg = 0;
		try {
	...
	public objetoDados getData(int key) {
		if (key >= this.numReg)
		return null;
